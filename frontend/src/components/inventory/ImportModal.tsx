    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-lg w-full shadow-2xl">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-800">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Importar Inventario</h2>
            ...
            <>
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500">
                      Columnas requeridas: sku, name, price_usd, cost_usd, quantity
                    </p>
                  </div>
                </label>
              </div>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 flex gap-3">
                ...
                <p className="text-xs text-amber-700 dark:text-amber-400">
                  Si el SKU ya existe, el producto se actualizará. Si no existe, se creará uno nuevo.
                </p>
              </div>
